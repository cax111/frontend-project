      ...
      <v-container>
        ...
        <v-card-title>
          ...
          <v-card-text>
            ...
            >
            <v-card-title>Gudang</v-card-title>
            <v-divider/>
            <v-card-text>
              <div v-for="(tampilGudang, index) in dataGudang"
              :key="tampilGudang.id">
              <v-checkbox
            ...
            <v-divider/>
            <v-card-text>
              <div v-for="(tampilSuppliers, index) in dataSuppliers" :key="tampilSuppliers.id">
              <v-checkbox
...
export default {
  ...
  methods: {
    ...
    deleteKategori(){
      if(this.banyakKategori.length>1){
